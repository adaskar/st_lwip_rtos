...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(m_OUT_1_GPIO_Port, m_OUT_1_Pin, GPIO_PIN_RESET);
  ...
  HAL_GPIO_Init(m_OUT_1_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : m_OUT_0_Pin */
  GPIO_InitStruct.Pin = m_OUT_0_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(m_OUT_0_GPIO_Port, &GPIO_InitStruct);
