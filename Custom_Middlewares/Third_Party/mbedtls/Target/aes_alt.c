...
/* Define missing macros for mbedTLS 3.x */
#ifndef MBEDTLS_INTERNAL_VALIDATE_RET
#define MBEDTLS_INTERNAL_VALIDATE_RET(cond, ret) do { if (!(cond)) return (ret); } while(0)
#endif
#ifndef MBEDTLS_INTERNAL_VALIDATE
#define MBEDTLS_INTERNAL_VALIDATE(cond) do { if (!(cond)) return; } while(0)
#endif
